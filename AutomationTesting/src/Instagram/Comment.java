...
public class Comment {
    ...
    public void CommentPost() {
        ...
        searchbox1 = driver.findElement(By.xpath("//span[text()='Search']"));
         ...
         searchbox2.sendKeys("hcltech");
         searchbox2 = driver.findElement(By.xpath("/html/body/div[1]/div/div[1]/div/div[1]/div/div/div[1]/div[1]/section/nav/div[2]/div/div/div[2]/div[3]/div/div[2]/div/div[1]/a"));
         searchbox2.click();
 

         picture  = driver.findElement(By.xpath("/html/body/div[1]/div/div[1]/div/div[1]/div/div/div[1]/div[1]/section/main/div/div[3]/article/div[1]/div/div[1]/div[1]/a"));
         ...
         Like.click();
         Comment= driver.findElement(By.xpath(
